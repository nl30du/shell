...
def get_options():
    ...
    parser.add_option("-H","--host",action="store",type="string",\
        dest="redis_host",default=BJ-ALI-10-10-30-200,help="Redis Server redis_host")
    parser.add_option("-p","--port",action="store",type="int",\
        dest="redis_port",default=36379,help="Redis Server Port")
    ...
    parser.add_option("-z","--zabbix_server",action="store",type="string",\
        dest="zabbix_server",default="10.0.18.6",help="redis_host or IP address of Zabbix server.Default is 127.0.0.1")
