...
[ -d /data/www ] && mkdir -p /data/backup/${time_dir} && cd /data/www/ && tar zcf /data/backup/${time_dir}/$PROJECT.tar.gz $PROJECT
...
cd /home/tomcat/ && tar xf weshop.tar.gz -C /data/www/ && rm -rf /home/tomcat/weshop.tar.gz
